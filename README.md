...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-c-kz7ew.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-c-kz7ew.containers.anotherwebservice.com/
...
```
git clone git@github.com:samgo94/container-c-kz7ew.git
cd container-c-kz7ew
```
...
```
docker attach container-c-kz7ew
```
